<template>
 <div>
    ...
    <p style="color:white; font-size:0.65cm">
      ...
      <br>This year we participated in a web development course and we learned new things that are very usefull in the industry like: Javascript, Html, Node.Js and Vue.
    ...
    <p style="color:white; font-size:0.65cm"><u>You can watch our previous projects in Github:</u>
      ...
      <br>
      Assignment 3.2:
      <a href="https://github.com/SISE-Web-Development-Environments/assignment-3-2-shay_gal-assignment3-1">Link to assignment 3.2 - Server side</a>
      <br>
      Assignment 3.3:
